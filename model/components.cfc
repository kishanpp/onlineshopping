...
<cfcomponent displayname = "OnlineShoppingDatabaseConnectivity" hint = "Handles the Database connectivity">
	...
	return type 		  	 :	numeric
	--->
	<cffunction name = "getproductbyname" output = "true" returntype = "numeric" access = "remote" hint = "returns product sub category details after searching with name ">
	...
	return type 		  	 :	query
	--->
	<cffunction name = "retrieve_data1" output = "true" returntype = "query" access = "public" hint = "returns product details of id 13">
	...
	return type 		  	 :	query
	---> 
	<cffunction name = "retrieve_data2" output = "true" returntype = "query" access = "public" hint = "returns product details of id 15">
		<cfquery name = "product_details"  >
			SELECT *
			FROM dbo.ProductSubCategory
	...
	return type 		  	 :	query
	--->
	<cffunction name = "retrieve_data3" output = "true" returntype = "query" access = "public" hint = "returns product details of id 17">
		<cfquery name = "product_details" >
			SELECT *
			FROM dbo.ProductSubCategory
	...
	return type 		  	 :	query
	--->
	<cffunction name = "retrieve_data4" output = "true" returntype = "query" access = "public" hint = "returns product details of id 23">
		<cfquery name = "product_details" >
			SELECT *
			FROM dbo.ProductSubCategory
	...
	return type 		  	 :	query
	--->
	<cffunction name = "retrieve_data5" output = "true" returntype = "query" access = "public" hint = "returns product details of id 14">
		<cfquery name = "product_details" >
			SELECT *
			FROM dbo.ProductSubCategory
	...
	return type 		  	 :	query
	--->
	<cffunction name = "retrieve_data6" output = "true" returntype = "query" access = "public" hint = "returns product details of id 16">
		<cfquery name = "product_details" >
			SELECT *
			FROM dbo.ProductSubCategory
	...
	return type 		  	 :	query
	--->
	<cffunction name = "retrieve_data7" output = "true" returntype = "query" access = "public" hint = "returns product details of id 18">
		<cfquery name = "product_details" >
			SELECT *
			FROM dbo.ProductSubCategory
	...
	return type 		  	 :	query
	--->
	<cffunction name = "retrieve_data8" output = "true" returntype = "query" access = "public" hint = "returns product details of id 24">
		<cfquery name = "product_details" >
			SELECT *
			FROM dbo.ProductSubCategory
	...
	return type 		  	 :	query
	--->
	<cffunction name = "getdatabyid" output = "true" returntype = "query" access = "public" hint = "returns product details searched by id">
	...
	description				 :	this function retrieves the product sub category quantity of the argument id and compares with cart product quantity.
	arguments description	 :	id - id of the product sub category.
	return type 		  	 :	boolean
	--->
	<cffunction name = "getproductqty" output = "true" returntype = "boolean" access = "public" hint = "returns true/false according to condition">
	...
	return type 		  	 :	void
	--->
	<cffunction name = "addressstore" output = "true" returntype = "void" access = "public" hint = "inserts the users address" >
	...
	return type 		  	 :	void
	--->
	<cffunction name = "updateaddress" output = "true" returntype = "void" access = "public" hint = "updates the users address">
		<cfargument name = "name" type = "string" required = "true">
		<cfargument name = "address" type = "string" required = "true">
		<cfargument name = "city" type = "string" required = "true">
		<cfargument name = "state" type = "string" required = "true">
	...
	return type 		  	 :	void
	--->
	<cffunction name = "paymentdetails" output = "true" returntype = "void" access = "public" hint = "inserts the users credit card details">
	...
	return type 		  	 :	query
	--->
	<cffunction name = "gettotalamount" output = "true" returntype = "query" access = "public" hint = "returns the total amount of the cart items">
		<cfquery name = "orderDetails">
	...
	return type 		  	 :	query
	--->
	<cffunction name = "getitems" output = "true" returntype = "query" access = "public" hint = "returns the product details of current order" >
	...
	return type 		  	 :	query
	--->
	<cffunction name ="getaddress" output = "true" returntype = "query" access = "public" hint = "retrieves the current user address">
	...
	return type 		  	 :	numeric
	--->
	<cffunction name = "updatecart" output = "true" returntype = "numeric" access = "remote" hint = "add products to cart and returns total cart quantity">
		...
		<cfquery name = "cartDetails" >
			SELECT * FROM dbo.Cart WHERE ( phoneNumber = <cfqueryparam value = '#SESSION.userPhoneNumber#' cfsqltype = "cf_sql_varchar">
									AND	 InventorySubCategoryId = <cfqueryparam value = #ARGUMENTS.productId# cfsqltype = "cf_sql_numeric">)
		</cfquery>
		<cfquery name = "productSubCategoryDetails" >
		...
		<cfif cartDetails.recordCount EQ 0>
			<cfquery>
				INSERT INTO dbo.Cart (phoneNumber,InventorySubCategoryId,OrderQty,ProductSubCategoryPrice) VALUES (<cfqueryparam value = '#SESSION.userPhoneNumber#' cfsqltype = "cf_sql_varchar">,
																							<cfqueryparam value = #ARGUMENTS.productId# cfsqltype = "cf_sql_numeric">,
																							1,
																							<cfqueryparam value = #LOCAL.discountedvalue# cfsqltype = "cf_sql_numeric">
																						)
			</cfquery>
	...
	return type 		  	 :	query
	--->
	<cffunction name = "getcartdataid" output = "true" returntype = "query" access = "remote" hint = "returns product id and quantity of products in cart">
		<cfquery name = "cartDetails" >
	...
	return type 		  	 :	query
	--->
	<cffunction name = "getcartdata" returntype = "query" access = "public" hint = "returns product details by id">
		<cfargument name = "id" type = "numeric" required = "true">
		<cfquery name = "productSubCategoryDetails" >
			SELECT * FROM dbo.ProductSubCategory WHERE InventorySubCategoryId = <cfqueryparam value = #ARGUMENTS.id# cfsqltype = "cf_sql_numeric">
		</cfquery>
	...
	return type 		  	 :	query
	--->
	<cffunction name = "getno" output = "true" returnType = "query" access = "public" hint = "returns total quantity in cart">
	...
	return type 		  	 :	JSON
	--->
	<cffunction name = "removefromcart" output = "true" returntype = "any" access = "public" hint = "returns cart total amount and quantity">
		<cfargument name = "productId" type = "numeric" required = "true">
		<cfquery>
			DELETE FROM dbo.Cart
			WHERE ( phoneNumber = <cfqueryparam value = '#SESSION.userPhoneNumber#' cfsqltype = "cf_sql_varchar"> AND 
					InventorySubCategoryId = <cfqueryparam value = #ARGUMENTS.productId# cfsqltype = "cf_sql_numeric">)
		</cfquery>
		...
		<cfif cartTotal.total GTE 0>
			<cfset LOCAL.cartvalue = cartTotal.total>
		<cfelse>
			<cfset LOCAL.cartvalue = 0>
		</cfif>
		<cfset LOCAL.response = {totalamount = Ceiling(LOCAL.total), cart = LOCAL.cartvalue } />
	...
	return type 		  	 :	numeric
	--->
	<cffunction name = "getcartitemstotalamount" output = "true" returntype = "numeric" access = "public" hint = "returns total cart product amount value">
		<cfquery name = "cartDetails" >
			SELECT * FROM dbo.Cart WHERE phoneNumber = <cfqueryparam value = '#SESSION.userPhoneNumber#' cfsqltype = "cf_sql_varchar"> 
		</cfquery>
		<cfset LOCAL.total = 0 />
	...
	return type 		  	 :	array
	--->
	<cffunction name = "productname" access = "remote" returntype = "array" hint = "returns product names matched with argument value">
	...
	return type 		  	 :	query
	--->
	<cffunction name = "inventorycategory" output = "true" returntype = "query" access = "public" hint = "returns product details">
		<cfquery name = "productCategoryDetails" >
			SELECT * FROM dbo.ProductCategory
		</cfquery>
		<cfreturn productCategoryDetails>
	...
	return type 		  	 :	array
	--->
	<cffunction name = "inventorysubcategory" returntype = "query" access = "public" hint = "return product sub category details">
		<cfargument name = "pname" type = "string" required = "true" default = "">
	...
	return type 		  	 :	void
	--->
	<cffunction name = "deletedata" output = "false" returntype = "void" access = "public" hint = "delete product">
	...
	return type 		  	 :	query
	--->
	<cffunction name = "inventorysubcategorydata" output = "false" returntype = "query" access = "public" hint = "returns product Sub Category Details">
	...
	return type 		  	 :	void
	--->
	<cffunction name = "updatedata" output = "false" returntype = "void" access = "public" hint = "update products">
	...
	return type 		  	 :	void
	--->
	<cffunction name = "updatedatawithoutimg" output = "false" returntype = "void" access = "public" hint = "update products" >
		<cfargument name = "psubnameselect" type = "string" required = "true" default = "">
		<cfargument name = "psubname" type = "string" required = "true" default = "">
		<cfargument name = "qty" type = "numeric" required = "true" default = "">
		<cfargument name = "pprice" type = "numeric" required = "true" default = "">
	...
	return type 		  	 :	query
	--->
	<cffunction name = "getproduct" returnType = "query" access = "public" hint = "returns the productsubcategory details">
	...
	return type 		  	 :	query
	--->
	<cffunction name = "getOrder" returnType = "query" access = "public" hint = "returns the Orders of current user">
	...
	return type 		  	 :	query
	--->
	<cffunction name = "getOrderDetails" returnType = "query" access = "public" hint = "returns the OrdersDetails of current user">
	...
	return type 		  	 :	query
	--->
	<cffunction name = "getProductDetails" returnType = "query" access = "public" hint = "returns the Orders of current user">
