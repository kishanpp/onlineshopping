<!--- 
filename 		: footer.cfm
function 		: This file display the footer information of the page.
...
<body>
	<footer class = "footer">
			...
			<p>
				...
				started Shoponline.com - India’s largest online marketplace,
				 ...
				 and international brands and retailers.Online Shopping – A Boon The trend of online shopping is becoming a household name . 
				  ...
				  one to be a technology aficionado then we have good news for you. Shopping online particularly at ShopOnline is a child’s play;
		...
		<span>Copyright © 2017, Shop Online Private Limited. All Rights Reserved</span>
	</footer>
</body>
</html>